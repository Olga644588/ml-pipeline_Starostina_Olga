...
class SequentialABTester:
    ...
    def add_observation(self, is_test: bool, metrics: Dict[str, float]) -> str:
    ...
    def _check_stopping(self) -> str:
        n = min(len(self.control_metrics["f1_score"]), len(self.test_metrics["f1_score"]))
